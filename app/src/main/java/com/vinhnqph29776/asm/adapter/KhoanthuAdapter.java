...
public class KhoanthuAdapter extends RecyclerView.Adapter<KhoanthuAdapter.ViewHolder> {
    ...
    private List<ObjKT> mData;
    private List<ObjLT> listlt;
    private LayoutInflater mInflater;
    private Data dt;

    // data is passed into the constructor
    public KhoanthuAdapter(Context mcontext, List<ObjKT> data) {
            ...
            public void onClick(View view) {
                ...
                if(d.isEmpty()){
                    ...
                    try {
                        ...
                        dt.updateKhoan(uid,a, b, formatedDate, loaithu, c, d, e,"khoanthu");
